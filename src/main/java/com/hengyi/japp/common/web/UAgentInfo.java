...
public class UAgentInfo {
    ...
    public boolean isMobilePhone = false; // Stores the result of
    // DetectMobileQuick()
    ...
    public boolean isAndroidPhone = false; // Stores the result of
    // DetectAndroidPhone()
    public boolean isTierTablet = false; // Stores the result of
    // DetectTierTablet()
    public boolean isTierIphone = false; // Stores the result of
    // DetectTierIphone()
    public boolean isTierRichCss = false; // Stores the result of
    // DetectTierRichCss()
    public boolean isTierGenericMobile = false; // Stores the result of
    ...
    public boolean detectIphone() {
        ...
        return userAgent.indexOf(deviceIphone) != -1 && !detectIpad()
                && !detectIpod();
    }
    ...
    public boolean detectAndroid() {
        if ((this.initCompleted == true) || (this.isAndroid == true)) {
    ...
    public boolean detectAndroidPhone() {
        if ((this.initCompleted == true) || (this.isAndroidPhone == true)) {
    ...
    public boolean detectWebkit() {
        if ((this.initCompleted == true) || (this.isWebkit == true)) {
    ...
    public boolean detectBlackBerryTouch() {
        return detectBlackBerry()
                ...
                || userAgent.indexOf(deviceBBBoldTouch) != -1 || userAgent
                .indexOf(deviceBBCurveTouch) != -1);
    }
    ...
    public boolean detectOperaAndroidPhone() {
        return userAgent.indexOf(engineOpera) != -1
                && (userAgent.indexOf(deviceAndroid) != -1 && userAgent
                .indexOf(mobi) != -1);
    }
    ...
    public boolean detectSmartphone() {
        ...
        return (detectTierIphone() || detectS60OssBrowser()
                || detectSymbianOS() || detectWindowsMobile()
    ...
    public boolean detectMobileQuick() {
        ...
        if (detectDangerHiptop() || detectMidpCapable() || detectMaemoTablet()
                || detectArchos()) {
            return true;
        }
    ...
    public boolean detectTierTablet() {
        if ((this.initCompleted == true) || (this.isTierTablet == true)) {
    ...
    public boolean detectTierIphone() {
        ...
        return detectIphoneOrIpod() || detectAndroidPhone()
                || detectWindowsPhone() || detectBlackBerry10Phone()
                || (detectBlackBerryWebKit() && detectBlackBerryTouch())
                || detectPalmWebOS() || detectBada() || detectTizen()
    ...
    public boolean detectTierRichCss() {
        if ((this.initCompleted == true) || (this.isTierRichCss == true)) {
        ...
        if (detectMobileQuick()) {
            ...
            if (!detectTierIphone() && !detectKindle()) {
                ...
                if (detectWebkit() || detectS60OssBrowser()
                        || detectBlackBerryHigh() || detectWindowsMobile()
    ...
    public boolean detectTierOtherPhones() {
        if ((this.initCompleted == true) || (this.isTierGenericMobile == true)) {
