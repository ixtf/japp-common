...
import static org.apache.poi.xwpf.converter.xhtml.internal.XHTMLConstants.*;
...
public class DocxToHtml extends XHTMLMapper {
    ...
    public DocxToHtml(XWPFDocument document, ContentHandler contentHandler, XHTMLOptions options) throws Exception {
